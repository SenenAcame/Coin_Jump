...
Hexadecimal [16-Bits]
                             ...
                             26 .include "cpctelera_functions.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             28 .include "man/entity_manager.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             30 .include "sys/animation_system.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             31 .include "sys/render_system.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             32 
   2AF6                      33 rendersys_init::
   2AF6 CD 1F 3B      [17]   34     call    cpct_disableFirmware_asm        ;;  Desactiva el Firmware
   2AF9 0E 00         [ 7]   35     ld      c,      #0                      ;;  C = 0
   2AFB CD 12 3B      [17]   36     call    cpct_setVideoMode_asm           ;;  Establece el modo de video 0
   2AFE 21 85 0F      [10]   37     ld      hl,     #_global_pal            ;;  HL = paleta de colores
   2B01 11 10 00      [10]   38     ld      de,     #size_pal               ;;  DE = tamaño de la paleta
   2B04 CD 74 31      [17]   39     call    cpct_setPalette_asm             ;;  Establece la paleta de colores
   0011                      40     cpctm_setBorder_asm HW_WHITE            ;;  Borde de pantalla gris
                              1    .radix h
   0011                       2    cpctm_setBorder_raw_asm \HW_WHITE ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   2B07 21 10 00      [10]    2    ld   hl, #0x010         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   2B0A CD 87 31      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   2B0D CD 67 2B      [17]   41     call    rendersys_tilemap               ;;  Pinta mapa en pantalla
   2B10 C9            [10]   42 ret
                             43 
   2B11                      44 rendersys_one_entity:
   2B11 CD 3D 2B      [17]   45     call    rendersys_erase             ;;  Borrar la posicion anterio
   2B14 DD 4E 00      [19]   46     ld      c,      e_x(ix)             ;;  X
   2B17 DD 46 01      [19]   47     ld      b,      e_y(ix)             ;;  Y
   2B1A CD 60 2B      [17]   48     call    rendersys_initScrPos        ;;  Posicion de pantalla en bytes (en HL)
   2B1D EB            [ 4]   49     ex      de,     hl                  ;;  Posicion de pantalla en bytes (en DE)
   2B1E D5            [11]   50     push    de                          ;;  Guardar posicion de pantalla en la pila
                             51 
   2B1F CD C0 27      [17]   52     call    animationsys_getSprite      ;;  Sprite actual (DE)
   2B22 CD EB 27      [17]   53     call    animationsys_setSprite      ;;  Siguiente sprite (e_sp)
                             54    
   2B25 EB            [ 4]   55     ex      de,     hl                  ;;  Sprite actual (HL)
   2B26 D1            [10]   56     pop     de                          ;;  Recoger posicion de pantalla (DE)
                             57 
   2B27 DD 4E 02      [19]   58     ld      c,      e_w(ix)             ;;  Ancho
   2B2A DD 46 03      [19]   59     ld      b,      e_h(ix)             ;;  Alto
   2B2D CD BA 39      [17]   60     call    cpct_drawSprite_asm         ;;  Pinta el sprite en pantalla
                             61     
   2B30 F1            [10]   62     pop     af                          ;;  Recojo de la pila el numero de entidades
   2B31 E1            [10]   63     pop     hl                          ;;  Recojo en HL la direccion de la etiqueta
   2B32 E9            [ 4]   64     jp      (hl)                        ;;  Salto a la etiqueta
                             65 
   2B33                      66 rendersys_update::
   2B33 CD C6 2C      [17]   67     call    entityman_getIX_A               ;;  Establece los registros IX y A
   2B36 21 11 2B      [10]   68     ld      hl,     #rendersys_one_entity   ;;  Guardo en HL la direccion de la funcion
   2B39 CD 0B 2D      [17]   69     call    entityman_forall                ;;  Llamo a entityman_forall
   2B3C C9            [10]   70 ret
                             71 
                             72 ;;  Input
                             73 ;;  IX: Posicion de la entidad
   2B3D                      74 rendersys_erase:
   2B3D DD 7E 00      [19]   75     ld      a,      e_x(ix)                 ;;  Guarda en A la posicion x (x)
   2B40 DD 4E 04      [19]   76     ld      c,      e_vx(ix)                ;;  Guarda en C la velocidad x (vx)
   2B43 91            [ 4]   77     sub     c                               ;;  Resta C a A (x-vx)
   2B44 4F            [ 4]   78     ld      c,      a                       ;;  Guarda en C la nueva posicion x
   2B45 DD 7E 01      [19]   79     ld      a,      e_y(ix)                 ;;  Guarda en A la posicion y (y)
   2B48 DD 46 05      [19]   80     ld      b,      e_vy(ix)                ;;  Guarda en B la velocidad y (vy)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 116.
Hexadecimal [16-Bits]



   2B4B 90            [ 4]   81     sub     b                               ;;  Resta B a A (y-vy)
   2B4C 47            [ 4]   82     ld      b,      a                       ;;  Guarda en B la nueva posicion y
   2B4D CD 60 2B      [17]   83     call    rendersys_initScrPos            ;;  Obtiene la posicion de memoria de video de las posiciones x e y
   2B50 AF            [ 4]   84     xor     a                               ;;  Igualamos A a 0
   2B51 CD 55 2B      [17]   85     call    rendersys_paintBox              ;;  Pintamos un cuadrado con el color de fondo (A)
   2B54 C9            [10]   86 ret
                             87 
                             88 ;;  Input
                             89 ;;  A: color
   2B55                      90 rendersys_paintBox:
   2B55 EB            [ 4]   91     ex      de,     hl                  ;;  Intercambio de valores
   2B56 DD 4E 02      [19]   92     ld      c,      e_w(ix)             ;;  Ancho
   2B59 DD 46 03      [19]   93     ld      b,      e_h(ix)             ;;  Alto
   2B5C CD 2F 3B      [17]   94     call    cpct_drawSolidBox_asm       ;;  Pinta un cuadrado con el color A
   2B5F C9            [10]   95 ret
                             96 
   2B60                      97 rendersys_initScrPos:
   2B60 11 00 C0      [10]   98     ld      de,     #CPCT_VMEM_START_ASM    ;;  Guarda en DE el principio de la pantalla     
   2B63 CD F6 3B      [17]   99     call    cpct_getScreenPtr_asm           ;;  Posicion de pantalla en bytes (en HL)
   2B66 C9            [10]  100 ret
                            101 
   2B67                     102 rendersys_tilemap::
   2B67 21 35 03      [10]  103     ld      hl,     #_tiles_00                  ;;  Guarda el principio del arrray de tiles
   2B6A 11 14 00      [10]  104     ld      de,     #width_map                  ;;  Ancho del mapa en tiles completo
   2B6D 01 14 19      [10]  105     ld      bc,     #size_window                ;;  Alto y ancho en tiles de la ventana que muestra el mapa
   2B70 CD 39 3C      [17]  106     call    cpct_etm_setDrawTilemap4x8_ag_asm   ;;  Setea la configuracion de la ventana
                            107 
   2B73 CD E1 30      [17]  108     call    gameman_get_map                     ;;  Esquina superior izquierda desde la que empezara a dibujar
   2B76 21 00 C0      [10]  109     ld      hl,     #CPCT_VMEM_START_ASM        ;;  Inicio de la posicion de momria de video (no puede ser cualquiera)                  
   2B79 CD 5A 3A      [17]  110     call    cpct_etm_drawTilemap4x8_ag_asm      ;;  Dibujado del mapa
                            111 
                            112 
   2B7C 21 0A 01      [10]  113     ld      hl,     #0x010A
   2B7F CD D3 3B      [17]  114     call    cpct_setDrawCharM0_asm
                            115 
   2B82 CD E9 30      [17]  116     call    gameman_get_string
   2B85 21 00 C0      [10]  117     ld      hl,     #0xC000
   2B88 CD 0A 2C      [17]  118     call    _myDrawStringM0
   2B8B CD 8F 2B      [17]  119     call    rendersys_drawStringIntro
   2B8E C9            [10]  120 ret
                            121 
                            122 ;HL -> Posicion
                            123 ;IY -> String
   2B8F                     124 rendersys_drawStringIntro::
   2B8F 21 0A 05      [10]  125     ld      hl,     #0x050A
   2B92 CD D3 3B      [17]  126     call    cpct_setDrawCharM0_asm
   2B95 CD 2B 31      [17]  127     call    comprueba_intro
   2B98 21 C0 C3      [10]  128     ld      hl,     #0xC3C0
   2B9B CD 0A 2C      [17]  129     call    _myDrawStringM0
   2B9E C9            [10]  130 ret
