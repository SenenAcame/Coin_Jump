...
Hexadecimal [16-Bits]
                             ...
                             27 .include "man/entity_manager.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             28 .include "man/game_manager.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             29 .include "sys/animation_system.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             30 .include "sys/input_controls.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
                             ...
                             24 
                             25 ;;  Funciones
                             26 .globl inpunt_keyboard
                             27 
                             28 ;;  Constantes
                     FFFFFFFF    29 move_left    = -1
                     0001    30 move_right   = 1
                     0000    31 border_left  = 0
                     004E    32 border_right = 78
...
Hexadecimal [16-Bits]
                             ...
                             32 .include "sys/music_system.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;    Coin Jump: a videogame developed for Amstrad CPC 464.                            ;;
                              3 ;;    Copyright (C) 2022  Senén Martínez Acame & Sergio Tortajada Santonja             ;;
                              4 ;;                                                                                     ;;
...
Hexadecimal [16-Bits]
                             ...
                             33 
   29AB                      34 jumptable:
   29AB F8 F9                35     .db     #-8, #-7
   29AD FA FA FB FB          36     .db     #-6, #-6, #-5, #-5
   29B1 FC FC FD FD          37     .db     #-4, #-4, #-3, #-3
   29B5 FE FE FF FF          38     .db     #-2, #-2, #-1, #-1
   29B9 00 00 00 00          39     .db      #0,  #0,  #0,  #0
   29BD C8                   40     .db     #200
                             41 
                             42 ;;  Input
                             43 ;;  IX: puntero a la entidad
   29BE                      44 inpunt_keyboard::
   29BE CD CD 2C      [17]   45     call  entityman_getEntityArray_IX
   29C1 DD 36 04 00   [19]   46     ld      e_vx(ix),  #0
   29C5 DD 36 05 00   [19]   47     ld      e_vy(ix),  #0
                             48 
   29C9 CD 08 3C      [17]   49     call  cpct_scanKeyboard_asm
   29CC CD FD 3A      [17]   50     call  cpct_isAnyKeyPressed_asm
   29CF 28 70         [12]   51     jr    z,   kb_end 
                             52     
   29D1                      53     Q_pressed:
   29D1 DD 7E 08      [19]   54         ld      a,  e_a(ix)
   29D4 B7            [ 4]   55         or      a
   29D5 20 21         [12]   56         jr      nz, O_pressed
   29D7 21 08 08      [10]   57         ld    hl,   #Key_Q
   29DA CD 68 31      [17]   58         call  cpct_isKeyPressed_asm
   29DD 20 10         [12]   59         jr    nz, Q_key 
                             60 
   29DF                      61     Joy_fire_press:
   29DF DD 7E 08      [19]   62         ld      a,  e_a(ix)
   29E2 B7            [ 4]   63         or      a
   29E3 20 13         [12]   64         jr      nz, O_pressed
   29E5 21 09 10      [10]   65         ld      hl,   #Joy0_Fire1
   29E8 CD 68 31      [17]   66         call    cpct_isKeyPressed_asm
   29EB 20 02         [12]   67         jr      nz, Q_key 
   29ED 18 09         [12]   68         jr      O_pressed
                             69 
   29EF                      70     Q_key:
   29EF CD 8E 2A      [17]   71         call    musicsys_jump
   29F2 CD CF 27      [17]   72         call    animationsys_playerJump         ;;  Cambia la animacion a saltar
   29F5 CD 4A 2A      [17]   73         call    jumpcontrol
                             74         
                             75 
   29F8                      76     O_pressed:
   29F8 21 04 04      [10]   77         ld    hl,   #Key_O
   29FB CD 68 31      [17]   78         call  cpct_isKeyPressed_asm
   29FE 20 22         [12]   79         jr    nz, O_key
                             80 
   2A00                      81     Joy_left_press:
   2A00 21 09 04      [10]   82         ld    hl,   #Joy0_Left
   2A03 CD 68 31      [17]   83         call  cpct_isKeyPressed_asm
   2A06 20 1A         [12]   84         jr    nz, O_key
                             85 
   2A08                      86     P_pressed:
   2A08 21 03 08      [10]   87         ld    hl,   #Key_P
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 108.
Hexadecimal [16-Bits]



   2A0B CD 68 31      [17]   88         call  cpct_isKeyPressed_asm
   2A0E 20 20         [12]   89         jr    nz, P_key
                             90 ;        jr    kb_end 
                             91 
   2A10                      92     Joy_right_press:
   2A10 21 09 08      [10]   93         ld    hl,   #Joy0_Right
   2A13 CD 68 31      [17]   94         call  cpct_isKeyPressed_asm
   2A16 20 18         [12]   95         jr    nz, P_key
                             96 ;        jr    kb_end 
                             97        
   2A18                      98     E_pressed:                          ;;  /
   2A18 21 07 04      [10]   99         ld    hl,   #Key_E              ;;  |
   2A1B CD 68 31      [17]  100         call  cpct_isKeyPressed_asm     ;;  |   Codigo de prueba
   2A1E 20 1E         [12]  101         jr    nz, E_key                 ;;  |   Avisar antes de modificar
   2A20 18 1F         [12]  102         jr    kb_end                    ;;  |
                            103                                         ;;  |
                            104 ;    R_pressed:                          ;;  |
                            105 ;        ld    hl,   #Key_R              ;;  |
                            106 ;        call  cpct_isKeyPressed_asm     ;;  |   Codigo de prueba
                            107 ;        jr    nz, R_key                 ;;  |   Avisar antes de modificar
                            108 ;        jr    kb_end                    ;;  \
                            109 
   2A22                     110     O_key:
   2A22 3E 00         [ 7]  111         ld    a,        #border_left
   2A24 DD BE 00      [19]  112         cp    e_x(ix)
   2A27 CA 41 2A      [10]  113         jp    z,        kb_end
   2A2A DD 36 04 FF   [19]  114         ld    e_vx(ix),  #move_left
   2A2E 18 11         [12]  115         jr    kb_end
                            116 
   2A30                     117     P_key:
   2A30 3E 4E         [ 7]  118         ld    a,        #border_right
   2A32 DD BE 00      [19]  119         cp    e_x(ix)
   2A35 CA 41 2A      [10]  120         jp    z,        kb_end
   2A38 DD 36 04 01   [19]  121         ld    e_vx(ix),  #move_right
   2A3C 18 03         [12]  122         jr    kb_end
                            123 
   2A3E                     124     E_key:                              ;;  /   Codigo de prueba
   2A3E CD 98 30      [17]  125         call  gameman_check_end         ;;  |   Avisar antes de modificar
                            126                                         ;;  |
                            127 ;    R_key:                              ;;  |   Codigo de prueba
                            128 ;        call gameman_restart_level      ;;  \   Avisar antes de modificar
                            129 
   2A41                     130     kb_end:
   2A41 DD 7E 08      [19]  131         ld      a,      e_a(ix)         ;;  Si esta saltando, sigue haciendo el salto
   2A44 FE 02         [ 7]  132         cp      #2
   2A46 CA 54 2A      [10]  133         jp      z,      jumping
   2A49 C9            [10]  134     ret
                            135 
   2A4A                     136 jumpcontrol:
   2A4A DD 7E 08      [19]  137     ld      a,      e_a(ix) 
   2A4D B7            [ 4]  138     or      a   
   2A4E C0            [11]  139     ret     nz                      ;;  Si es 0 esta en el suelo
   2A4F 3E 02         [ 7]  140     ld      a,          #2
   2A51 DD 77 08      [19]  141     ld      e_a(ix),     a
   2A54                     142     jumping:
...
Hexadecimal [16-Bits]
   ...
   2A54 DD 7E 09      [19]  143         ld      a,              e_va(ix)
   2A57 4F            [ 4]  144         ld      c,              a
   2A58 06 00         [ 7]  145         ld      b,              #0
   2A5A 21 AB 29      [10]  146         ld      hl,             #jumptable
   2A5D 09            [11]  147         add     hl,             bc    
   2A5E 7E            [ 7]  148         ld      a,              (hl)
   2A5F FE C8         [ 7]  149         cp      #200
   2A61 CA 6F 2A      [10]  150         jp      z,              end_jump
                            151 
   2A64 DD 77 05      [19]  152         ld      e_vy(ix),       a
   2A67 DD 7E 09      [19]  153         ld      a,              e_va(ix)
   2A6A 3C            [ 4]  154         inc     a
   2A6B DD 77 09      [19]  155         ld      e_va(ix),  a
   2A6E C9            [10]  156     ret
   2A6F                     157     end_jump:
   2A6F CD D6 27      [17]  158         call    animationsys_playerWalk     ;;  Cambia la animacion a caminar
   2A72 3E 01         [ 7]  159         ld      a,          #1
   2A74 DD 77 08      [19]  160         ld      e_a(ix),     a
   2A77 3E 00         [ 7]  161         ld      a,          #0
   2A79 DD 77 09      [19]  162         ld      e_va(ix),     a
   2A7C C9            [10]  163     ret
