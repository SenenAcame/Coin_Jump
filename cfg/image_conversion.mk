...
## 16 colours palette
PALETTE = 2 0 3 6 9 13 14 15 18 25 24 26 20 21 1 4
...
$(eval $(call IMG2SP, SET_PALETTE_FW,  $(PALETTE)))
$(eval $(call IMG2SP, CONVERT_PALETTE, $(PALETTE), global_pal))

$(eval $(call IMG2SP, CONVERT, assets/img/Animacion_player.png,  8,  8, sp_player))
$(eval $(call IMG2SP, CONVERT, assets/img/Pinchos.png, 			14,  6, sp_spikes))
$(eval $(call IMG2SP, CONVERT, assets/img/Pinchos_arr.png, 	    14,  6, sp_spikes_up))
$(eval $(call IMG2SP, CONVERT, assets/img/Pinchos_der.png, 	     6, 14, sp_spikes_rig))
$(eval $(call IMG2SP, CONVERT, assets/img/Pinchos_izq.png, 	     6, 14, sp_spikes_lef))
$(eval $(call IMG2SP, CONVERT, assets/img/Animacion_moneda.png, 10, 10, sp_coin))
#$(eval $(call IMG2SP, CONVERT, assets/img/Animacion_canyon.png, 8, 	6, 	sp_cannon))
#$(eval $(call IMG2SP, CONVERT, assets/img/Bola_canyon.png, 		4, 	4, 	sp_cannon_ball))
#$(eval $(call IMG2SP, CONVERT, assets/img/Animacion_laser.png, 	8, 	6, 	sp_laser))

$(eval $(call IMG2SP, SET_IMG_FORMAT, zgtiles))
$(eval $(call IMG2SP, CONVERT, assets/img/Tiles_suelo8x8.png, 	8, 	8, 	tiles))
